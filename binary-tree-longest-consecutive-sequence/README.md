<h2>298. Binary Tree Longest Consecutive Sequence</h2><h3>Medium</h3><hr><div><p>Given a binary tree, find the length of the longest consecutive sequence path.</p>
